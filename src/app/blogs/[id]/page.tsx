...
import { Calendar, ArrowLeft, MapPin, Share2, Quote, Sparkles, UserCheck, ShieldCheck } from 'lucide-react';
...
export default function BlogDetailPage() {
    ...
    const getImageUrl = (imgId: string) => {
        return PlaceHolderImages.find(img => img.id === imgId)?.imageUrl || 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&q=80&w=1200';
    };
