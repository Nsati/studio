 ...
 * Features a symmetric, editorial layout with high-quality visuals.
 */
        ...
        <div className="min-h-screen bg-white selection:bg-accent selection:text-white">
            ...
            <article className="pb-48">
                ...
                <div className="container mx-auto max-w-7xl px-6 mb-24">
                    <div className="relative aspect-[21/9] w-full rounded-[3.5rem] overflow-hidden shadow-apple-deep bg-slate-100">
                        <Image 
                        ...
                        <footer className="mt-32 p-16 bg-[#fcfcf9] rounded-[3.5rem] border border-black/5 flex flex-col md:flex-row items-center justify-between gap-12 text-center md:text-left">
                            <div className="flex items-center gap-8">
                                ...
                                <div className="space-y-2">
                                    <p className="text-[10px] font-black uppercase text-accent tracking-[0.4em]">Verified Discovery Intelligence</p>
                                    <p className="text-4xl font-black text-slate-900 tracking-tight">Harrier Liaison</p>
