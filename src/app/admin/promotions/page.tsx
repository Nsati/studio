        ...
        try {
            if (isEditing) {
                if (promotion.id !== docId) {
                    ...
                    await setDoc(promotionRef, { id: docId, ...values });
                } else {
...
function PromotionsTable({ promotions, onEdit, onDelete }: { promotions: Promotion[], onEdit: (p: Promotion) => void, onDelete: (p: Promotion) => void }) {
    return (
        <Table>
            <TableHeader>
                <TableRow>
